						...
						<ul class="navi">
							...
							<li style="width: 40px;"><a href="SHOP/장바구니/basket.jsp"
								style="width: 40px; height: 40px; margin: 0 20px;"><img
									src="../../images/장바구니.jpg" style="width: 40px; height: 40px"></a>
							<li style="width: 200px;" class="active"><a href="메뉴판.jsp"
	...
	<div class="wrp">
		<div class="wrapper">
			<div class="menu-eat">
				...
				<div class="menuItem" onclick="changePage('과일 쥬스')">과일 주스</div>
