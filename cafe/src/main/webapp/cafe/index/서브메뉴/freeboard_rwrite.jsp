...
<%
String loginna = (String) session.getAttribute("joinName");
...
<BODY>
	...
	<FORM name='msgrewrite' method=POST
		...
		<table width="900" cellspacing="0" cellpadding="2">
			...
			<tr>
				<td colspan="2" bgcolor="#DFEDFF" height="20" class="notice">&nbsp;&nbsp;<font class="EC">글 답변하기</font></td>
			</tr>
			<tr>
				<td colspan="2" bgcolor="#1F4F8F" height="1"></td>
			</tr>
			<tr>
				...
				<td width="494" style="padding: 0 0 0 10"><input
						type="text" name="name" class="input_style1"></td>
			</tr>
			<tr>
				<td width="124" align="center" bgcolor="#f4f4f4">E-mail</td>
				<td width="494" style="padding: 0 0 0 10" height="25"><input
						type="text" name="email" class="input_style1" value="<%=loginid%>"
						readonly></td>
			</tr>
			<tr>
				<td width="124" align="center" bgcolor="#f4f4f4">제 목</td>
				<td width="494" style="padding: 0 0 0 10" height="25"><input
					type=text name=subject size="60" class="input_style2"
			...
			<tr>
				...
				<td width="494" valign="top" style="padding: 5 0 5 10"><textarea
						name=content cols="65" rows="10" class="textarea_style1">
