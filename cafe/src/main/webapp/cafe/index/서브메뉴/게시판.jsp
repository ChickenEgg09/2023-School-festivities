        ...
        <div class="wrapper">
            <div class="tabmenu">
                <ul class="tabmenu-wrap">
                    <li class="active"><a href="게시판.jsp">게시판</a></li>
                    ...
                    <div class="noti-listwrap">
                        <div class="noti-list">
                            ...
                            <div>
                                ...
                                <div class="title"><a href="../게시판/회원탈퇴.jsp">회원탈퇴</a></div>
                                <div class="writer">별임</div>
                                <div class="date">2023.08.01</div>
                                <div class="count">32</div>
                            </div>
                            <div>
                                <div class="num">24</div>
                                <div class="title"><a href="../게시판/처음.jsp">처음 가봅니다.</a></div>
                                <div class="writer">고독한늑대</div>
                                <div class="date">2023.05.23</div>
                                <div class="count">583</div>
                            </div>
                            <div>
                                <div class="num">23</div>
                                <div class="title"><a href="../게시판/새단장.jsp">새단장 축하드립니다.</a></div>
                                <div class="writer">개지</div>
                                <div class="date">2022.12.27</div>
                                <div class="count">645</div>
                            </div>
                            <div>
                                <div class="num">22</div>
                                <div class="title"><a href="../게시판/직친.jsp">직원분들이 친절하시네요</a></div>
                                <div class="writer">쩌맘</div>
                                <div class="date">2022.10.16</div>
                                <div class="count">826</div>
                            </div>
                        </div>
                    </div>
                </div>
