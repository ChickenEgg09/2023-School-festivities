...
<BODY>
	<P>
	<P align=center>
		<FONT color=#0000ff face=굴림 size=20> <STRONG>자유
				게시판(검색모드)</STRONG>
		</FONT>
	</P>
	...
	<CENTER>
		<TABLE border=0 width=1200px cellpadding=4 cellspacing=0>
			<tr align="center">
			...
			try {
				...
				id = totalrows - j;
				if (j % 2 == 0) {
					out.println("<TR bgcolor='#FFFFFF' onMouseOver=\" bgColor='#DFEDFF'\" onMouseOut=\"bgColor=''\" class=center-tr>");
				} else {
					out.println(
