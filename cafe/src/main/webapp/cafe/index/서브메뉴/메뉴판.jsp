...
<body>
                ...
                <li>
                    <nav class="menu" style="width: 1040px;">
                        <ul class="navi">
                            ...
                            <li style="width: 40px;"><a href="SHOP/장바구니/basket.jsp" style="width: 40px; height: 40px; margin: 0 20px;"><img src="../../images/장바구니.jpg" style="width: 40px; height: 40px"></a>
                            <li style="width: 200px;" class="active"><a href="메뉴판.jsp" onMouseOver='this.innerHTML="MENU"' onMouseOut='this.innerHTML="메뉴"'>메뉴</a></li>
    ...
    <div class="wrp">
        <div class="wrapper">
            <div class="menu-eat">  
                <div class="menuItem" onclick="changePage('커피')">커피</div>
                <div class="menuItem" onclick="changePage('라떼')">라떼</div>
                <div class="menuItem" onclick="changePage('과일 쥬스')">과일 쥬스</div>
                <div class="menuItem" onclick="changePage('스무디')">스무디</div>
                <div class="menuItem" onclick="changePage('아이스크림')">아이스크림</div>
                <div class="menuItem" onclick="changePage('티 & 허브티')">티 & 허브티</div>
                <div class="menuItem" onclick="changePage('디저트')">디저트</div>
                <div class="menuItem" onclick="changePage('식사와 안주')">식사와 안주</div>
            </div>
            <div id="content">
                <!-- 여기에 메뉴 내용을 표시합니다. 초기 내용은 비어 있습니다. -->
            </div>
        </div>
    </div>
    <footer>
