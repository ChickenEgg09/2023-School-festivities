	...
	<article>
		...
		<div id="product-list">
			...
			<div class="product-card">
				<a href="SHOP/원두콩.jsp?productName=<%=URLEncoder.encode("[갤러리 앨리스] 10월 원두콩", "UTF-8")%>">
					<div>
						<img class="product-img" src="../../images/원두콩.png" alt="원두">
					</div>
					<div class="product-contents">
						<span class="product-name">[갤러리 앨리스] 10월 원두콩</span><br> <span
							class="product-price">30,000원</span>
					</div>
				</a>
			</div>
			...
			<!-- product-card 2 -->
			<div class="product-card">
				<a href="SHOP/단풍.jsp?productName=<%=URLEncoder.encode("단풍 블렌드", "UTF-8")%>">
					<div>
						<img class="product-img" src="../../images/가을 블렌드.png"
							alt="계절 블렌드">
					</div>
					<div class="product-contents">
						<span class="product-name">단풍 블렌드</span><br> <br>
						<spanclass"product-price">25,000원</span>
					</div>
				</a>
			</div>

			<div class="product-card">
				<a href="SHOP/강릉.jsp?productName=<%=URLEncoder.encode("강릉 블렌드", "UTF-8")%>">
					<div>
						<img class="product-img" src="../../images/강릉 블랜드.png"
							alt="강릉 블렌드">
					</div>
					<div class="product-contents">
						<span class="product-name">강릉 블렌드 </span><br> <br> <span
							class="product-price">22,000원</span>
					</div>
				</a>
			</div>
			<div class="product-card">
				<a href="SHOP/강릉드립백.jsp?productName=<%=URLEncoder.encode("강릉 블렌드 드립백 세트 (10개입)", "UTF-8")%>">
					<div>
						<img class="product-img" src="../../images/강릉 블렌드 드립백.png"
							alt="강릉 블렌드 드립백">
					</div>
					<div class="product-contents">
