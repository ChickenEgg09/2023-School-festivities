            ...
            <div class="noti-wrap">
                <div class="noti-view-wrap">
                    <div class="noti-view">
                        ...
                        <div class="cont">
                            강의는 2종류의 와인시음(4인기준)과 안주, 그리고 강의를 포함, 한 강의당 4만원입니다<br><br>

초보자를 위한 와인궁금증 해소부터 와인레스토랑 주문방법, 와이너리여행, 비지니스 와인매너, 와인구매방법 등 실용적인 내용의 와인강의입니다.<br><br>

총 16강이지만 개별강좌 수강신청 가능해요<br><br>

10월 21일 첫 강의 시작으로 매주 금요일 19시에 진행됩니다. <br><br>
다만 수강신청인원이 4명 미만일시 자동 연기 됩니다<br><br>
                        </div>
                    </div>
                    <div class="nt-wrap">
