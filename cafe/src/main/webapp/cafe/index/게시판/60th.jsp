            ...
            <div class="noti-wrap">
                <div class="noti-view-wrap">
                    <div class="noti-view">
                        ...
                        <div class="cont">
                            RoseNBird는 La Ventana의 리더 정태호 피아니스트가<br>
                            근현대 실내악의 낭만적 소품들을 재해석 하여<br>
                            재즈 편성으로 연주하는 재즈밴드입니다.<br><br>
    
                            근현대실내악곡을 재즈로 편곡해 연주하는<br>
                            재즈밴드 RoseNBird입니다.<br>
                            품위있는 실내악곡들을 재즈로 감상하는<br>
                            아주 드문 연주회가 될 것입니다.<br><br>
    
                            2023. 5. 13(sat) 5 p.m. <br>
                            갤러리앨리스
                        </div>
                    </div>
                    <div class="nt-wrap">
